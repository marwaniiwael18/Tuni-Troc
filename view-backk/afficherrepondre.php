...
<?php
	...
	$listrepondre=$ReclamationC->afficherrepondre(); 
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
		...
		<div class="table-responsive">
			...
			<?php
				foreach($listrepondre as $repondre){
			?>
			<tr>
				<td><?php echo $repondre['id_repondre']; ?></td>
				<td><?php echo $repondre['message']; ?></td>
				<td><?php echo $repondre['email']; ?></td>
                <td><?php echo $repondre['id_rec']; ?></td>
                <td><?php echo $repondre['date']; ?></td>
                <td><?php echo $repondre['id_user']; ?></td>

				<td>
					<a href="supprimerrepondre.php?id_repondre=<?php echo $repondre['id_repondre']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
