                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" placeholder="Votre message" value="<?php echo $aviss['message']; ?>" id="message" class="form-control" name="message" >
                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <input class="btn hvr-hover" type="submit" value="modifier avis"> 
