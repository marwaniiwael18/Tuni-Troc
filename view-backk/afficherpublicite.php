...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
		...
		<div class="table-responsive">
			...
			<?php
				foreach($listePublicite as $Publicite){
			?>
			<tr>
				<td><?php echo $Publicite['id_publicite']; ?></td>
				<td><?php echo $Publicite['id_sponsor']; ?></td>
				<td><?php echo $Publicite['nom_publicite']; ?></td>
				<td><?php echo $Publicite['date_publicite']; ?></td>
                <td> <img src="images/<?php echo $Publicite['photo']; ?>" alt="" width="50" height="50"></td>
				...
				<td>
                <a href="modifierpublicite.php?id_publicite=<?php echo $Publicite['id_publicite']; ?>">modifier</a>

				</td>
				<td>
					<a href="supprimerpublicite.php?id_publicite=<?php echo $Publicite['id_publicite']; ?>">Supprimer</a>
				</td>
