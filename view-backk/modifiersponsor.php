...
<?php
    ...
    $Sponsors = $SponsorC->recuperersponsor($_GET["id_sponsor"]);
    ...
    if ($radio_val==null)
    {
        $radio_val=$Sponsors['type_sponsor'];
        $_POST["type_sponsor"]=$Sponsors['type_sponsor'];
    }


        if($_POST["type_sponsor"]=="Active")
        {
            $subscribe_price=25;
        }
          if($_POST["type_sponsor"]=="Dormant")
        {
            $subscribe_price=50;
        }
         if($_POST["type_sponsor"]=="Nominal")
        {
            $subscribe_price=75;
        }
         if($_POST["type_sponsor"]=="Partner")
        {
            $subscribe_price=200;
        }
            ...
            $SponsorC->modifiersponsor($Sponsor, $a);
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <button><a href="affichersponsor.php">Retour à la affichersponsor</a></button>
        <hr>
             ...
             <form id="" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="radio" id="type_sponsor" name="type_sponsor" value="Active" >Active  <br> 
                                     ...
                                     <input type="radio" id="type_sponsor" name="type_sponsor" value="Partner">Partner                        
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                    <input type="date" class="form-control" value="<?php echo $Sponsors['endsub_date']; ?>" name="endsub_date" id="endsub_date" />   
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                    <input type="text" class="form-control" value="<?php echo $Sponsors['sponsor_describe']; ?>" name="sponsor_describe" id="sponsor_describe" />   
                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <input class="btn hvr-hover" type="submit" value="modifier sponsor"> 
