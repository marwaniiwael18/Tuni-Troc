...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <a href="afficheruser.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Gestion user</a>
                    ...
                    <a href="affichercomment.php" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Gestion comment</a>
        ...
        <div class="content">
			...
			<button><a href="afficherposte.php">Ajouter un comment</a></button>
		<center><h1>Liste des comment</h1></center>
		<div class="row">
