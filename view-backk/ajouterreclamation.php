                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="nom_perso" name="nom_perso" placeholder="Votre nom_perso" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" placeholder="Votre prenom_perso" id="prenom_perso" class="form-control" name="prenom_perso" >
                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          <input type="text" class="form-control" id="num_tel" name="num_tel" placeholder="Votre num_tel" >
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="message" name="message" placeholder="Votre message" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <input class="btn hvr-hover" type="submit" value="ajouter reclamation"> 
                                    </div>
                                </div>
                            </div>
                        </form>
