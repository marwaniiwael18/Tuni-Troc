...
$SponsorC2=$SponsorC->recuperersponsorwithus($_SESSION["id_user"])["id_sponsor"];
        ...
        <form id="" method="POST">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" placeholder="Votre nom_publicite" id="nom_publicite" class="form-control" name="nom_publicite" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <input class="btn hvr-hover" type="submit" value="ajouter Publicite"> 
                                    </div>
                                </div>
                            </div>
                        </form>
