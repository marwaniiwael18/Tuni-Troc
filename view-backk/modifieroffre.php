    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
		...
		<?php
			if (isset($_GET["id_offre"])){
				$offres = $OffreC->recupererOffre($_GET["id_offre"]);
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" placeholder="Votre nom_offre" value="<?php echo $offres['nom_offre']; ?>" id="nom_offre" class="form-control" name="nom_offre" >
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                    <input type="text" class="form-control" value="<?php echo $offres['type']; ?>" name="type" id="type" placeholder="type" />   
