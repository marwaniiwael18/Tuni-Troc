    ...
    <button><a href="Ajouteruser.php">Ajouter un user</a></button>
		...
		<div class="table-responsive">
			...
			<tr>
                ...
                {
                    ?>
                                    <a href="ban.php?id_user=<?php echo $USER['id_user']; ?>&active=<?php echo $USER['active']; ?>">ban user</a>
                                    <?php 
                ...
                {
                    ?>
                                    <a href="ban.php?id_user=<?php echo $USER['id_user']; ?>&active=<?php echo $USER['active']; ?>">unban user</a>
