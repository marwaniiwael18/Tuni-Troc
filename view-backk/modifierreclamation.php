                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" placeholder="Votre nom_perso" value="<?php echo $reclamation['nom_perso']; ?>" id="nom_perso" class="form-control" name="nom_perso" >
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Votre prenom_perso"  value="<?php echo $reclamation['prenom_perso']; ?>" name="prenom_perso" id="prenom_perso" />   
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Votre email"  value="<?php echo $reclamation['email']; ?>" name="email" id="email" />   
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Votre num_tel"  value="<?php echo $reclamation['num_tel']; ?>" name="num_tel" id="num_tel" />   
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Votre message"  value="<?php echo $reclamation['message']; ?>" name="message" id="message" />   
                                ...
                                <div class="col-md-4">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <input class="btn hvr-hover" type="submit" value="modifier reclamation"> 
