    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
		...
		<div class="table-responsive">
			...
			<tr>
                ...
                <td> <img src="images/shop/products/<?php echo $produit['url_image']; ?>" alt="" width="50" height="50"></td>

                <td><?php echo $produit['code_categ']; ?></td>
                <td><?php echo $produit['id_scateg']; ?></td>
                <td><?php echo $produit['pu_achat']; ?></td>
                <td><?php echo $produit['pu_vente']; ?></td>
                <td><?php echo $produit['qte_stock']; ?></td>
                <td><?php echo $produit['date']; ?></td>
				
				<td>
                <a href="modifierprdouit.php?id_produit=<?php echo $produit['id_produit']; ?>">modifier</a>
