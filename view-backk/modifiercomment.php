                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" placeholder="Votre message" value="<?php echo $comments['message']; ?>" id="message" class="form-control" name="message" >
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                    <input type="file" class="form-control" value="<?php echo $comments['photo']; ?>" name="photo" id="photo" />   
